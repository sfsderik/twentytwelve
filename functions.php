...
function twentytwelve_setup() {
	...
	add_editor_style([asset_path('styles/tinymce.css'), twentytwelve_get_font_url()]);
...
function twentytwelve_get_font_url() {
	 ...
	 */
	if ( 'off' !== _x( 'on', 'Montserrat font: on or off', 'twentytwelve' ) ) {
		$subsets = 'latin,latin-ext';

		/* translators: To add an additional Open Sans character subset specific to your language,
		 * translate this to 'greek', 'cyrillic' or 'vietnamese'. Do not translate into your own language.
		 */
		$subset = _x( 'no-subset', 'Montserrat font: add new subset (greek, cyrillic, vietnamese)', 'twentytwelve' );
	...
	if ( 'off' !== _x( 'on', 'Nunito font: on or off', 'twentytwelve' ) ) {
		$subsets = 'latin,latin-ext';

		$subset = _x( 'no-subset', 'Nunito font: add new subset (greek, cyrillic, vietnamese)', 'twentytwelve' );
...
function twentytwelve_scripts_styles() {
	...
	wp_enqueue_script( 'twentytwelve-scripts', asset_path('scripts/main.js'), array( 'jquery' ), '20140711', true );
	wp_enqueue_script( 'twentytwelve-navigation', get_template_directory_uri() . '/js/navigation.js', array( 'jquery' ), '20140711', true );
	wp_localize_script('twentytwelve-scripts', 'rest_url', esc_url(rest_url('/spotzer/v1/')));
	...
	wp_enqueue_style( 'twentytwelve-style-optimized', asset_path('styles/main.css'), array( 'twentytwelve-style' ), '20121010' );

	// Loads the Internet Explorer specific stylesheet.
	wp_enqueue_style( 'twentytwelve-ie', asset_path('styles/ie.css'), array( 'twentytwelve-style' ), '20121010' );
